...
class DefuntiListView(View):
    ...
    def GET_render(self,request,*args, **kwargs):
        try:
            add_log(level=2,user=request.user, custom_message="Entering view DefuntiListView.GET_render",request=request)
...
class DefuntoEditView(View):
    ...
    def GET_render(self,request,*args, **kwargs):
        try:
            ...
            add_log(level=2,user=request.user, custom_message="Entering view DefuntoEditView.GET_render",request=request)
            #### Objects from post ####
...
class DefuntoDocsView(View):
    ...
    def GET_render(self,request,*args, **kwargs):
        try:
            add_log(level=2,user=request.user, custom_message="Entering view DefuntoDocsView.GET_render",request=request)
            id = kwargs.get("id", None)
            defunto = get_object_or_404(AnagraficaDefunto,pk=id)
...
class GetDocView(View):
    ...
    def GET_render(self, request, *args, **kwargs):
        try:
            ...
            add_log(level=2,user=request.user, custom_message="Entering view GetDocView.GET_render",request=request)
